...
Begin {C0E45035-5775-11D0-B388-00A0C9055D8E} DataEnvironment1 
   ...
   _ExtentY        =   17436
   FolderFlags     =   1
   TypeLibGuid     =   "{8D602045-D1EA-448E-AA5F-676DD1F2E188}"
   TypeInfoGuid    =   "{557D1499-D9C2-4139-A351-C48459F55715}"
   TypeInfoCookie  =   0
   Version         =   4
   NumConnections  =   1
   BeginProperty Connection1 
      ...
      ConnDispId      =   1001
      SourceOfData    =   3
      ConnectionSource=   "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=FVHS AR.mdb;Persist Security Info=False"
      QuoteChar       =   96
      SeparatorChar   =   46
   EndProperty
   NumRecordsets   =   2
