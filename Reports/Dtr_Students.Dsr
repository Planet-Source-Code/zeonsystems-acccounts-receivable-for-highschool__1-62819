VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} Dtr_Students 
   ...
   EndProperty
End
Attribute VB_Name = "Dtr_Students"
...
Private Sub DataReport_Initialize()
    Me.Sections("Section5").Controls.Item("label8").Caption = frm_stud_list.Text2
    'Me.Sections("Section3").Controls.Item("label14").Caption = frm_stud_list.Text3
End Sub
