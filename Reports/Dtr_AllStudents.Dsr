VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} Dtr_AllStudents 
   Caption         =   "DataReport1"
   ClientHeight    =   8595
   ClientLeft      =   60
   ClientTop       =   345
   ...
   EndProperty
End
Attribute VB_Name = "Dtr_AllStudents"
...
'    .Item("Label8").Caption = frm_stud_list.Text2
'End With
'End Sub
